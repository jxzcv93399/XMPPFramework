...
+ (void)removeMessageAndUpdateContactMessage:(XMPPMessageArchiving_Message_CoreDataObject *)message inMangedObjectContext:(NSManagedObjectContext *)context{
    ...
    contactMessage.mostRecentMessageBody = nextMessage.message.body?nextMessage.message.body:@"";
    contactMessage.mostRecentMessageOutgoing = nextMessage.outgoing?nextMessage.outgoing:contactMessage.mostRecentMessageOutgoing;
    contactMessage.mostRecentMessageTimestamp = nextMessage.timestamp?nextMessage.timestamp:contactMessage.mostRecentMessageTimestamp;
